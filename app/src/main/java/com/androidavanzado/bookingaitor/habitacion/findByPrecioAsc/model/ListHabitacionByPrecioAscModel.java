package com.androidavanzado.bookingaitor.habitacion.findByPrecioAsc.model;
...
public class ListHabitacionByPrecioAscModel implements ListHabitacionByPrecioAscContract.Model {
    ...
    private OnListPrecioAscListener onListPrecioAscListener;


    @Override
    public void listHabitacionPrecioAsc(OnListPrecioAscListener onListPrecioAscListener) {
        this.onListPrecioAscListener = onListPrecioAscListener;
        HashMap<String, String> param = new HashMap<>();
        param.put("ACTION", "HABITACION");
        param.put("QUERY", "FIND_BY_PRECIO_ASC");
    ...
    class PrecioAscAsyncTask extends AsyncTask<String, Integer, Boolean>{
        ...
        protected void onPostExecute(Boolean res) {
            if(res){
                ...
                onListPrecioAscListener.onReject("Error al traer los datos del servidor");
            }
        }
    }
}
